...
function M.setup()
	local lsp = {
		...
		DiagnosticHint = { fg = colors.elixir7 },
		...
		DiagnosticVirtualTextHint = { fg = colors.elixir7, bg = colors.elixir1 },
		...
		["@lsp.type.function"] = { fg = colors.elixir7 },
		["@lsp.type.interface"] = { fg = colors.elixir9 },
		["@lsp.type.macro"] = { fg = colors.elixir10 },
		["@lsp.type.method"] = { fg = colors.elixir7 },
		["@lsp.type.namespace"] = { fg = colors.elixir7 },
		...
		LspSignatureActiveParameter = { fg = colors.elixir7, bold = true },
		...
		["@keyword.readonly"] = { fg = colors.elixir7 },
		["@keyword.storage"] = { fg = colors.elixir7 },

		["@markup.strong"] = { bold = true },
		["@markup.italic"] = { italic = true },
		["@markup.heading"] = { fg = colors.elixir7, bold = true },
